...
export class TipoAtividadeComponent implements OnInit {
  ...
  verificaTipoAtividade(){
    ...
    if(this.tipoAtividade == "profissional-liberal")
      ...
      this.tipoAtividadeImpressao = "como Profissional Liberal, com declaração assinada pelo Contador, especificando ser a área inerente ao curso, informando a inscrição no respectivo Conselho de Classe, e comprovante do cadastro da Prefeitura Municipal (no caso deprestador de serviço)."
  ...
  imprimirRelatorioFinal(){
    ...
    doc.setFontSize(18);
     ...
     //Cabeçalho
     doc.text(doc.splitTextToSize(titulo_relatorio, (pdfInMM-lMargin-rMargin)),pageCenter,39,'center');
